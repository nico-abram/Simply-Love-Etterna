...
SL = {
	...
	Preferences = {
		Casual = {
			...
			TimingWindowSecondsW3=0.180000,
			TimingWindowSecondsW4=0.180000,
	...
	Metrics = {
		...
		Competitive = {
			...
			PercentScoreWeightW4=0,
			PercentScoreWeightW5=0,
			PercentScoreWeightMiss=-4,
			PercentScoreWeightLetGo=-4,
		...
		ECFA = {
			...
			PercentScoreWeightW2=1,
			PercentScoreWeightW3=0,
			PercentScoreWeightW4=0,
			PercentScoreWeightW5=0,
			PercentScoreWeightMiss=-1,
			PercentScoreWeightLetGo=0,
			PercentScoreWeightHeld=1,
			PercentScoreWeightHitMine=-1,
