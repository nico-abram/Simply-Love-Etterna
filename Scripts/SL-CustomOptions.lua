function OptionRowEditorNoteskin()
	...
	return {
		...
		LoadSelections = function(self, list, pn)
			local skin =
				PREFSMAN:GetPreference("EditorNoteSkinP1") or PREFSMAN:GetPreference("EditorNoteSkinP2") or
		...
		SaveSelections = SL.IsEtterna and function()
			end or function(self, list, pn)
				for i = 1, #skins do
					if list[i] then
