...
local t = Def.ActorFrame{
	...
	Def.Quad{
		...
		OnCommand=function(self)
			self:sleep(1.4):accelerate(0.6):diffusealpha(0)
		end
	},
	...
	LoadActor(image.."_splode")..{
		...
		OnCommand=function(self)
			self:sleep(0.4):diffuse(GetCurrentColor()): Center():rotationz(10):diffusealpha(0):zoom(0):diffusealpha(0.9):linear(0.6):rotationz(0):zoom(1.1):diffusealpha(0)
		end
	},
	LoadActor(image.."_splode")..{
		InitCommand=function(self)
		...
		OnCommand=function(self)
			self:sleep(0.4):diffuse(GetCurrentColor()): Center():rotationy(180):rotationz(-10):diffusealpha(0):zoom(0.2):diffusealpha(0.8):decelerate(0.6):rotationz(0):zoom(1.3):diffusealpha(0)
		end
	},
	LoadActor(image.."_minisplode")..{
		...
		OnCommand=function(self)
			self:sleep(0.4):diffuse(GetCurrentColor()): Center():rotationz(10):diffusealpha(0):zoom(0):diffusealpha(1):decelerate(0.8):rotationz(0):zoom(0.9):diffusealpha(0)
		end
	},
	...
	LoadFont("_wendy small")..{
		Text=text,
		InitCommand=function(self)
			self:Center():diffusealpha(0):shadowlength(1)
		end,
		OnCommand=function(self)
			self:accelerate(0.5):diffusealpha(1):sleep(0.66):accelerate(0.33):zoom(0.4):y(_screen.h-30)
		end,
