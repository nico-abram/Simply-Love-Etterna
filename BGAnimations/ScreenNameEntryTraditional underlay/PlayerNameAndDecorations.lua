...
local t = Def.ActorFrame{
	...
	Def.Quad{
		InitCommand=function(self)
			self:diffuse(color("0,0,0,0.75")):zoomto(300, _screen.h/7)
		end,
	},
	...
	Def.Quad{
		InitCommand=function(self)
			self:diffuse(color("0,0,0,0.5")):zoomto(300, _screen.h/10)
		end,
	...
	Def.Quad{
		InitCommand=function(self)
			self:diffuse(color("0,0,0,0.25")):zoomto(300, _screen.h/4)
		end,
		OnCommand=function(self)
			self:y(142)
		end
...
t[#t+1] = LoadFont("_wendy white")..{
	Name="PlayerName",
	InitCommand=function(self)
		self:zoom(0.75):halign(0):xy(-80,0)
	end,
	OnCommand=function(self)
		self:visible( CanEnterName )
...
t[#t+1] = LoadFont("_wendy small")..{
	...
	OnCommand=function(self)
		self:zoom(0.7):diffuse(PlayerColor(Player)):y(58):visible(not CanEnterName)
	end
}
