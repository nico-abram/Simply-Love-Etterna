...
if PREFSMAN:GetPreference("EasterEggs") and MonthOfYear() == 11 then
	af[#af + 1] =
		...
		InitCommand = function(self)
			self:zoom(0.225):xy(130, -self:GetHeight() / 2):rotationz(15):queuecommand("Drop")
		end,
		DropCommand = function(self)
			self:decelerate(1.333):y(-110)
		end
	}
end
