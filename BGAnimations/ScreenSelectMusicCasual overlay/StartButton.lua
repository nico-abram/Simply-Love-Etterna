...
return Def.ActorFrame{
	...
	InitCommand=function(self)
		self:diffusealpha(0):xy(_screen.cx, _screen.h-76)
	end,
	...
	LoadActor("./img/start_glow.png")..{
		...
		OnCommand=function(self)
			self: diffuseshift():effectcolor1(color("#55CC5500")):effectcolor2(color("#55CC55FF"))
		end,
	},
	...
	Def.Quad{
		Name="Quad",
		InitCommand=function(self)
			self: diffuseshift():effectcolor1(color("#33aa33")):effectcolor2(color("#55cc55")):zoomto(w, h)
		end,
	},
	...
	LoadFont("_miso")..{
		...
		InitCommand=function(self)
			self:diffuse(Color.Black):zoom(0.9)
		end,
		SwitchFocusToSingleSongMessageCommand=function(self)
